...
function(find_and_configure_nanoarrow)
    ...
    rapids_cpm_find(
            ...
            GIT_SHALLOW FALSE
            OPTIONS "BUILD_SHARED_LIBS OFF" "NANOARROW_NAMESPACE gpuspatial" ${_exclude_from_all}
    )
    set_target_properties(nanoarrow PROPERTIES POSITION_INDEPENDENT_CODE ON)
    rapids_export_find_package_root(BUILD nanoarrow "${nanoarrow_BINARY_DIR}" EXPORT_SET gpuspatial-exports)
endfunction()
